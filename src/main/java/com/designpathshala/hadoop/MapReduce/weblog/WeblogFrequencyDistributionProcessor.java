...
/**
 * Sorts by number of hits, received by each URL Will remove values with same
 * key(no of hits in this case) Takes inputs from the output of
...
// Input directory is output of WeblogHitsByLinkProcessor
// hadoop jar MapReduce-0.0.1-SNAPSHOT.jar
// com.designpathshala.hadoop.MapReduce.weblog.WeblogFrequencyDistributionProcessor
// /user/hue/dp/output /user/hue/dp/output1