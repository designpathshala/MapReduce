...
/**
 * Finds avg, min and max size of webpages received
 * Last token tells the webpage size.
 * Use file: access_log_Jul95 
 */
...
public class WebLogMessageSizeAggregator {
    ...
    public static class AReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
        public void reduce(Text key, Iterable<IntWritable> values, Context context) throws IOException,
            ...
            context.write(new Text("Avg"), new IntWritable((int) tot / count));
...
//  hadoop jar MapReduce-0.0.1-SNAPSHOT.jar com.designpathshala.hadoop.MapReduce.weblog.WebLogMessageSizeAggregator /user/hue/dp/weblog /user/hue/dp/output
